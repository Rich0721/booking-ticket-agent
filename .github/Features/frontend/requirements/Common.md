...
- UI設計圖: [早鳥](../UI/Commons/components/Bird.png)、[會員](../UI/Commons/components/Station.png)
...
- UI設計圖: [搭乘日期](../UI/Commons/components/Time.png)、[站別](../UI/Commons/components/Station.png)
...
- UI設計圖: [日期選擇](../UI/Commons/components/Date.png)
- icon: [日期選擇](../UI/Commons/icons/time-planning.png)
- 需求說明:
  - CSS需要有RWD功能
  - icon需置中放置，固定icon
  - 日期選擇:
    - 點選時跳出日期選擇器
    - 系統日以前(包含系統日)的日期不可選擇
    - 日期選擇完顯示在Textbox中，格式為YYYY-MM-DD
